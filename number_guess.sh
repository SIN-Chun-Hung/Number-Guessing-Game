...
# Define guess number game function
GUESS_NUMBER () {
  ...
  then
    ...
    echo  -e  "Hint: Please input a valid integer with no leading zero and between 1 to 1000, otherwise it is regarded as non-integer.\n"
    GUESS_NUMBER
  fi
}
